...
export const useLogin=()=>{
    ...
    const login=async (formData)=>{
        ...
        try {
            ...
            const response3=await axiosInstance.get('Auth/profile')

            const response1 = await axiosInstance.post('Home/show_created', {teacher: formData.username})

            console.log(response3)
            // const response2 = await axiosInstance.post('Hone/show_created')
            console.log(response3)
